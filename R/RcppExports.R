...
#'
#' @export
resample_fft_rcpp <- function(fftz, tapers, verbose = TRUE, dbl = TRUE, tapcap = 20000L) {
...
#'
#' @export
resample_mvfft <- function(fftz, tapers, verbose = TRUE, dbl = TRUE, tapcap = 20000L) {
...
#'
#' @export
resample_mvfft_parallel <- function(fftz, tapers, verbose = TRUE, dbl = TRUE, tapcap = 20000L) {
